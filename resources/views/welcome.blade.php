    ...
    <div class="min-h-full w-full">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{route('payment.destroy', $payment->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <button class="bg-red-500" type="submit">Eliminar registros</button>
                            </form>
                        </td>
                    </tr>
                @endforeach
        ...
        <div class="flex justify-center items-center mt-16">
            <div class="grid grid-cols-3 gap-5">
                ...
                <div class="bg-blue-500 px-10 pt-3 pb-10 rounded-lg flex-col">
                    <div class="flex justify-center">
                ...
                <div class="bg-red-500 px-10 pt-3 pb-10 rounded-lg flex-col">
                    ...
                    <div>
                        <span>Genera un reverso masivo atravez de un archivo de excel</span>

                        <div class="mt-5">
                            <form action="{{route('payment.store')}}" method="POST">
                                @csrf
                                <label for="" class="font-bold">Archivo: </label><br>
                                <input type="file" name="cardNumber" id="cardNumber" required>
                                <button type="submit" class="bg-gray-200 rounded-md p-1">Enviar</button>
                            </form>
                        </div>
                    </div>
